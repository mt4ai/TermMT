...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_path_termmt", type=str, required=True)
    parser.add_argument("--input_path_CAT", type=str, required=True)
    ...
    input_path_termmt = args.input_path_termmt
    input_path_CAT = args.input_path_CAT
    # seed = args.seed
    count = args.count



    json_lst_termmt = read_json(input_path_termmt)
    json_lst_CAT = read_json(input_path_CAT)
