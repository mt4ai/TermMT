...
def make_judge(output_path, trans_model, threshold_sentence, threshold_term, threshold_phrase_no_larger, gpt_bertins_judge_file=None):
    ...
    with open(output_path+f"/metamorphic_items_aligned_{trans_model}_sbert.json", 'r') as f:
    ...
    write_json_to_file(metamorphic_items_final, output_path+f"/metamorphic_items_final_{trans_model}-sbert.json")
