...
def venn2(labels, names=['A', 'B'], **options):
    ...
    # body
    draw_ellipse( ax, 0.4, 0.3, 0.3, 0.5, 0.0, colors[0])
    draw_ellipse( ax, 0.6, 0.3, 0.3, 0.5, 0.0, colors[1])
    draw_text(ax, 0.62, 0.30, labels.get('01', ''), fontsize=fontsize)
    draw_text(ax, 0.38, 0.30, labels.get('10', ''), fontsize=fontsize)
    draw_text(ax, 0.50, 0.30, labels.get('11', ''), fontsize=fontsize)

    # legend
    draw_text( ax, 0.30, 0.56, names[0], colors[0], fontsize=fontsize, ha="right", va="bottom")
    draw_text( ax, 0.70, 0.56, names[1], colors[1], fontsize=fontsize, ha="left", va="bottom")
