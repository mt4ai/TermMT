...
if __name__ == "__main__":
    ...
    for floder_name in floder_names:
        origin_file_path = f"../../detect-1-sth/results/{floder_name}/metamorphic_items.json"
    ...
    for model in models:
        ...
        for floder_name in floder_names:
            file_path = f"../../detect-1-sth/results/{floder_name}/error_{model}/metamorphic_item_error_gptfiltered.json"
    ...
    error_statis_dict["bing"]["all"] = len(bing_error_sentences)
    error_statis_dict["mbart"]["all"] = len(mbart_error_sentences)
    ...
    write_json(error_statis_dict, f"{output_path}/error_statis.json")