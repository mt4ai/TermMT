...
if __name__ == "__main__":
    ...
    for i in range(len(area_folders)):
        ...
        json_info_term_error_google = read_json(f"{area_folder}/error_google/metamorphic_item_phrase_infinsert_error_term_gptfiltered.json")
        json_info_sentence_error_google = read_json(f"{area_folder}/error_google/metamorphic_item_phrase_infinsert_error_sentence_gptfiltered.json")
        json_bert_replace_error_google = read_json(f"{area_folder}/error_google/metamorphic_item_phrase_bertinsert_error_term_gptfiltered.json")
        json_info_term_error_mbart = read_json(f"{area_folder}/error_mbart/metamorphic_item_phrase_infinsert_error_term_gptfiltered.json")
        json_info_sentence_error_mbart = read_json(f"{area_folder}/error_mbart/metamorphic_item_phrase_infinsert_error_sentence_gptfiltered.json")
        json_bert_replace_error_mbart = read_json(f"{area_folder}/error_mbart/metamorphic_item_phrase_bertinsert_error_term_gptfiltered.json")
        json_info_term_error_bing = read_json(f"{area_folder}/error_bing/metamorphic_item_phrase_infinsert_error_term_gptfiltered.json")
        json_info_sentence_error_bing = read_json(f"{area_folder}/error_bing/metamorphic_item_phrase_infinsert_error_sentence_gptfiltered.json")
        json_bert_replace_error_bing = read_json(f"{area_folder}/error_bing/metamorphic_item_phrase_bertinsert_error_term_gptfiltered.json")
        ...
        jsons_info_term_error_mbart.extend(json_info_term_error_mbart)
        jsons_info_sentence_error_mbart.extend(json_info_sentence_error_mbart)
        jsons_bert_replace_error_mbart.extend(json_bert_replace_error_mbart)
        jsons_info_term_error_bing.extend(json_info_term_error_bing)
        jsons_info_sentence_error_bing.extend(json_info_sentence_error_bing)
        jsons_bert_replace_error_bing.extend(json_bert_replace_error_bing)
    ...
    sample_questionaire_item(jsons_info_term_error_mbart, 100, 1234,  os.path.join(output_path, "info_term_error_mbart.csv"), "info_term")
    sample_questionaire_item(jsons_info_sentence_error_mbart, 100, 1234,  os.path.join(output_path, "info_sentence_error_mbart.csv"), "info_sentence")
    sample_questionaire_item(jsons_bert_replace_error_mbart, 100, 1234,  os.path.join(output_path, "bert_replace_error_mbart.csv"), "bert_replace")
    sample_questionaire_item(jsons_info_term_error_bing, 100, 1234,  os.path.join(output_path, "info_term_error_bing.csv"), "info_term")
    sample_questionaire_item(jsons_info_sentence_error_bing, 100, 1234,  os.path.join(output_path, "info_sentence_error_bing.csv"), "info_sentence")
    sample_questionaire_item(jsons_bert_replace_error_bing, 100, 1234,  os.path.join(output_path, "bert_replace_error_bing.csv"), "bert_replace")
