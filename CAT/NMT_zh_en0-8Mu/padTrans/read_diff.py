...
def read_from_wdiff(old_sentence, new_sentence):
    #print (old_sentence)
    f = open(f"{data_folder}/memory_2.txt", "w")
    f.write(old_sentence.strip())
    f.close()
    f = open(f"{data_folder}/memory_1.txt", "w")
    f.write(new_sentence.strip())
    f.close()

    diff = os.popen(f"wdiff {data_folder}/memory_1.txt {data_folder}/memory_2.txt")
...
def com_bleu(en, new, ora, en_old, en_new):
    ...
    for i in range(len(en)):
        ...
        #print (score)
        sum_ += score
    f_com = open(f"{data_folder}/Com_BLEU.txt", "w")
    l = sorted(l)[::-1]
...
f = open(f"{data_folder}/Com_Mutated.en", "r")
en_new_lines = f.readlines()
f.close()

f = open(f"{data_folder}/Com_Original.en", "r")
en_old_lines = f.readlines()
f.close()

f = open(f"{data_folder}/Com_Mutated.zh", "r")
new_lines = f.readlines()
f.close()

f = open(f"{data_folder}/Com_Original.zh", "r")
old_lines = f.readlines()
f.close()

f = open(f"{data_folder}/Com_oracle.zh", "r")
...
f_edit = open(f"{data_folder}/Com_Answer.zh", "w")
...
write_all(lcs_l, ed_l, tfidf_l, bleu_l, lcs_d, ed_d, tfidf_d, f"{data_folder}/Com_ALL.txt")
...
write_file(lcs_l, f"{data_folder}/Com_LCS.txt")
write_file(ed_l, f"{data_folder}/Com_ED.txt")
write_file(tfidf_l, f"{data_folder}/Com_TFIDF.txt")
write_file(bleu_l, f"{data_folder}/Com_BLEU.txt")
write_file(lcs_d, f"{data_folder}/Com_LCS_d.txt")
write_file(ed_d, f"{data_folder}/Com_ED_d.txt")
write_file(tfidf_d, f"{data_folder}/Com_TFIDF_d.txt")
